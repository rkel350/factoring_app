...
st.markdown("For 2 or 3 term polynomials, enter the full equation (e.g. `x^2 -49` or `2x^2 +6x -3`). \nFor 4 terms or higher, enter the coefficients of your polynomial as comma-separated values (e.g. `2, 3, 1` for `2x² + 3x + 1`)")
st.markdown('<p style="color:red;">Note: Variables MUST be in lowercase!</p>', unsafe_allow_html=True)
